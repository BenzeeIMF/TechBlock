...
import com.techblock.dao.UserDao;
...
//            user.setProfile(imageName);
            ...
            if (ans) {
                ...
                AlertContent alertContent = new AlertContent("alert-success", "Details Updated Successfully", "Your details has saved");
                ...
                AlertContent alertContent = new AlertContent("alert-danger", "Something went Wrong", "Your details hasn't saved! Kindly try again in some time");
                session.setAttribute("alertContent", alertContent);
